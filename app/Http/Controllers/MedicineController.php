...
// }
            ...
            $customer->mfg_date = $request->mfg_date ?: null;
            $customer->exp_date = $request->exp_date ?: null;
...
// Redirect based on product_type
    ...
    public function edit( Request $request, $id ) {
        ...
        if ( $request->isMethod( 'post' ) ) {
            ...
            $medicine->mfg_date = $request->mfg_date ?: null;
            $medicine->exp_date = $request->exp_date ?: null;
