...
// Assuming you have a 'Purchase' model for storing purchases
...
// Assuming `supplier_id` is a field in the Medicine model
...
// Accessing 'qty' from the array
    ...
    public function getMedicines( Request $request ) {
        ...
        $query = Medicine::with( 'supplier', 'type' )
            ->select( 'id', 'name', 'generic_name', 'price', 'image', 'supplier_id', 'strength', 'product_type', 'type_id' )
            ->where( 'status', 1 );
