            ...
            <div class="content-body">
                <div class="auth-wrapper auth-cover">
                    <div class="auth-inner row m-0">
                        ...
                        <img height="60" width="320" src="{{ globalAsset(setting('logo'), 'settings') }}" alt="Logo"/>
                        ...
                        <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5 ">
                            <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                                ...
                                <form class="auth-login-form mt-2" action="{{ route('login') }}" method="POST">
                                    @csrf
                                    <div class="mb-1">
                                        <label class="form-label" for="login-email">{{ translate('common.email') }}
                                        </label>
                                    ...
                                    <div class="mb-1">
                                        <div class="d-flex justify-content-between">
                                            <label class="form-label"
                                                for="login-password">{{ translate('common.password') }}</label>
                                        </div>
                                        <div class="input-group input-group-merge form-password-toggle">
                                            <input
                                                class="form-control form-control-merge  @error('password') is-invalid @enderror"
                                                id="password" placeholder="Enter your password" name="password"
                                                required autocomplete="current-password" type="password" /><span
                                    ...
                                    <div class="mb-1 d-flex justify-content-between align-items-center">
                                        <div class="form-check">
                                            ...
                                            <label class="form-check-label" for="remember-me">
                                                {{ translate('common.Remember Me') }} </label>
                                        </div>
                                        <a href="{{ route('password.request') }}"
                                            class="text-link">{{ translate('common.forgot password') }}</a>
                                    </div>
                                    <button class="btn btn-dark w-100 text-black"
                                        tabindex="4">{{ translate('common.Sign in') }}</button>
