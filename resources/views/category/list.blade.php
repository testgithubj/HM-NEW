@extends('layouts.app')
@section('title', translate('common.category'))
...
@section('content')
            <x-container title="Categorys" buttonTitle="Add Category" buttonRoute="{{ route('category.add') }}">
            <div class="table-responsive pt-0">
                <table class="user-list-table table table-bordered border-dark">
                    ...
                    <tbody></tbody> <!-- Body will be populated by DataTable -->
                </table>
            </div>
        </x-container>
@endsection
...
<script>
    ...
    <!-- Include DataTable JS and related libraries -->
    ...
    $(function() {
        ...
        var table = $('.user-list-table').DataTable({
            processing: false,
            serverSide: true,
            ajax: "{{ route('category') }}", // AJAX request to the controller
            columns: [
