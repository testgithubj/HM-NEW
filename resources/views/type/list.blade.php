    ...
    <!-- <section class="app-user-list">
        <div class="card">
            <div class="card-body border-bottom">
                <h4 class="card-title">{{ translate('common.types') }}</h4>
                <div class="dt-action-buttons text-xl-end text-lg-start text-lg-end text-start ">
                    <div class="dt-buttons"><a class="dt-button btn btn-primary btn-add-record ms-2" tabindex="0"
                            ...
                            href="{{ route('type.add') }}"><span>{{ translate('common.type_add') }}</span></a> </div>
                </div>
            </div> -->

        <x-container title="type" buttonTitle="Add type" buttonRoute="{{ route('type.add') }}">
